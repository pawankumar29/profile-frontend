...
function Contact() {
    ...
    const budgetOptions = ['< $500', '$500 - $1,500', '$1,500 - $5,000', '$5,000+'];
        ...
        <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-5xl mx-auto w-full">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="glass rounded-xl p-4 flex items-center gap-4">
                        <div className="gradient-bg w-10 h-10 rounded-lg flex items-center justify-center shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-mail text-primary-foreground">
                    ...
                    <div className="glass rounded-xl p-4 flex items-center gap-4">
                        <div className="gradient-bg w-10 h-10 rounded-lg flex items-center justify-center shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-map-pin text-primary-foreground">
                ...
                <div className="lg:col-span-3">
                    <form onSubmit={handleSubmit} className="glass rounded-xl p-6 md:p-8 space-y-5 relative overflow-hidden">
                        {error && (
                            <div className="bg-destructive/10 border border-destructive/20 text-destructive text-sm p-4 rounded-lg animate-in fade-in">
                                {error}
                            </div>
                        )}
